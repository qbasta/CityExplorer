...
{
    /// <inheritdoc />
    public partial class DatabaseAnotherFix : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LandmarkCategories", x => new { x.LandmarkId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_LandmarkCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LandmarkCategories_Landmarks_LandmarkId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LandmarkCategories_CategoryId",
                table: "LandmarkCategories",
                column: "CategoryId");
